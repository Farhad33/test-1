...
export default function Home() {
    return (
        <Container>
            <Section1>
                <TopImgMicky src={'images/mickey-photos/2.png'} alt="Micky Hits The Ball" />
                <InnerSection>
                    <H2>Mickey</H2>
                    <H1>Mantle</H1>
                    <TopImgBall src={'images/mickey-photos/baseball-fire.jpg'} alt="The ball on top" />
                    <TheAmericanDreamImg1 src={'images/mickey-photos/header.jpeg'} alt="The American Dream comes to life" /> 
                </InnerSection>
            </Section1> 
            <Section2>
                <MickyOnLeftImg src={'images/mickey-photos/Micky-1.jpg'} alt="Micky Smiling" />
                <div>
                    <TheAmericanDreamImg2 src={'images/mickey-photos/header.jpeg'} alt="The American Dream comes to life" /> 
                    <Article>
            ...
            <Section3>
                <div>
                    ...
                    <MickeyFamilyImg src={'images/mickey-photos/mm-family.jpeg'} alt="Mickey Mantle image with family" /> 
